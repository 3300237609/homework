...
public interface HomeworkService {
     ...
     * @return 作业列表+分页信息
     */
    R<List<Homework>> getHomeworkList(Long clazzId, Integer pageNum, Integer pageSize);
     ...
     * @return 学生作业列表
     */
    R<List<Homework>> getStudentHomeworkList(Long courseId, String status, Integer pageNum, Integer pageSize);
     ...
     * @return 学生视角的作业详情
     */
    R<Homework> getStudentHomeworkDetail(Long homeworkId);
    R<String> submitWork(Long homeworkId, String content, List<HomeworkSubmitDetail> answerList);
}